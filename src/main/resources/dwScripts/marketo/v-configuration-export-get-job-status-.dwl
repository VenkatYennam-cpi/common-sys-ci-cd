...
---
{
	...
	"path" : if (attributes.requestPath contains "leads")p('marketo.path.bulkExportRetrieveJobStatusLeads') else p('marketo.path.bulkExportRetrieveJobStatusActivities')
